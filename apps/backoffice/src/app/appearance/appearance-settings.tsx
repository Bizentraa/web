...
import { getThemePreset, THEME_PRESETS, type ThemeMode, type ThemePreset } from "@bizentra/themes";
  ...
  return (
    <form className="theme-settings" onSubmit={(event) => void save(event)}>
      ...
      <section className="theme-panel">
        <div className="theme-section-heading">
          <div>
            ...
            <h2>Choose an industry preset</h2>
          </div>
      ...
      <div className="theme-two-column">
        <section className="theme-panel">
          ...
          <p className="theme-help">
            Keep the preset colours, or set a controlled primary/accent pair. Status colours such as
            danger, warning and success never change.
          </p>
          <ColourOverride
        ...
        <section className="theme-panel">
          ...
          <label className="theme-field">
            ...
            <select
              ...
              onChange={(event) =>
                theme.setDeviceMode(event.target.value as Parameters<typeof theme.setDeviceMode>[0])
              }
            >
      ...
      <div className="theme-save-bar">
        ...
        <button className="theme-primary-button" disabled={theme.status === "saving"} type="submit">
